...
- Entender o design (Semiótica, tipografia, gerenciamento de cores, distribuição dos elementos, formas, fechamento de arquivo, etc)
- Dominio em software
...
Ninguem consegue se desenvolver sozinho, precisa de pessoas.
